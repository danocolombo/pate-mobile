...
<html>
    ...
    <body>
        ...
        <p>
            ...
            related to it, still belong to Fortson Guru.
        </p>
        <p>
            Fortson Guru is committed to ensuring that the app is as useful and
        ...
        <p>
            The FEO app stores and processes personal data that you have
            ...
            phone’s security features and it could mean that the FEO app
        ...
        <p>
            You should be aware that there are certain things that Fortson Guru
            ...
            but Fortson Guru cannot take responsibility for the app not working
        ...
        <p>
            Along the same lines, Fortson Guru cannot always take responsibility
            ...
            it on to avail the Service, Fortson Guru cannot accept
            responsibility.
        </p>
        <p>
            With respect to Fortson Guru’s responsibility for your use of the
            ...
            that we can make it available to you. Fortson Guru accepts no
        ...
        <p>
            ...
            to keep using the app. Fortson Guru does not promise that it will
        ...
        <p>These terms and conditions are effective as of 2022-07-15</p>
        <p><strong>Contact Us</strong></p>
        <p>
            If you have any questions or suggestions about my Terms and
            Conditions, do not hesitate to contact us at support@fortson.guru.
        </p>
        <p>
