...
const EventDetails = (theEvent) => {
    ...
    //     state.rallies.allRallies.filter((r) => r.uid === theEvent.id)
    // );
    // printObject('S.C.R.RD:28==>>>REDUX', rallyIn.rally);
    const rally = theEvent.rally;
    ...
    const lDate = dateNumsToLongDayLongMondayDay(
                            ...
                            <Card style={styles.rallyCard}>
                                ...
                                <View style={styles.timeContainer}>
                                    <Text style={styles.timeValues}>
                                        {displayAWSTime(rally.startTime)} -{' '}
                                        {displayAWSTime(rally.endTime)}
                                    </Text>
                                </View>
